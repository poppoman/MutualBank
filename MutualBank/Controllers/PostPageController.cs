    ...
    public class PostPageController : Controller
    {
        ...
        public ActionResult AddreComment(int id, string content, int parentid, int touserid)
        {
            ...
            msgnewVM vm = new msgnewVM()
            {
                ...
                childtoUserHphoto = User.UserHphoto == null ? User.UserSex == true ? Path.Combine(_userPhotoFilePath, "Male.PNG") : Path.Combine(_userPhotoFilePath, "Female.PNG") : Path.Combine(_userPhotoFilePath, User.UserHphoto),
